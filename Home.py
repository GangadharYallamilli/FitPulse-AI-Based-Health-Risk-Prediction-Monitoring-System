...
/* ── HEADER: hide chrome but keep the sidebar toggle visible ── */
header[data-testid="stHeader"] {
    background: transparent !important;
    height: 0 !important;
    min-height: 0 !important;
    overflow: visible !important;   /* lets the toggle button escape */
}
...
/* Make sure the collapsed-control toggle is always fully visible */
...
/* Also keep the collapse arrow inside the open sidebar visible */
